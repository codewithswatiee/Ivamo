  ...
  return (
    <footer className="bg-[#111] text-white px-6 md:px-12 py-12 relative">
      ...
      <div className=" mx-auto">
        <div className="mb-8">
          {/* inline logo svg (provided) */}
          <div className="w-[100%] max-w-full mx-auto text-center overflow-hidden">
            <svg width="100%" viewBox="0 0 152 17" preserveAspectRatio="xMidYMid meet" className="block mx-auto" fill="none" xmlns="http://www.w3.org/2000/svg">
